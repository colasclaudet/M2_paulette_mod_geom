...
void MeshViewerWidget::mousePressEvent( QMouseEvent* _event )
{
    ...
    if(_event->buttons() == Qt::RightButton)
    {
        ...
        /*first_point_to_cut3D =
                cos(this->angle_)*first_point_to_cut3D +
                sin(this->angle_)*(this->axis_*first_point_to_cut3D) +
                (1-cos(this->angle_))*(this->axis_*first_point_to_cut3D)*this->axis_;*/
        first_point_to_cut3D = first_point_to_cut3D*cos(this->angle_)+
                this->axis_*(this->axis_*first_point_to_cut3D)*
                (1-cos(this->angle_))+(first_point_to_cut3D*this->axis_)*sin(this->angle_);
        ...
        //rotate(this->axis_,this->angle_);
        //glRotated(this->angle_,first_point_to_cut3D[0],first_point_to_cut3D[1],first_point_to_cut3D[2]);
        //first_point_to_cut3D = OpenMesh::Vec3f(first_point_to_cut3D[0]*cos(this->angle_),first_point_to_cut3D[1]*sin(this->angle_),first_point_to_cut3D[2]) ;
...
void MeshViewerWidget::mouseReleaseEvent( QMouseEvent* _event  )
{
    ...
    /*last_point_to_cut3D =
            cos(this->angle_)*last_point_to_cut3D +
            sin(this->angle_)*(this->axis_*last_point_to_cut3D) +
            (1-cos(this->angle_))*(this->axis_*last_point_to_cut3D)*this->axis_;*/
    last_point_to_cut3D = last_point_to_cut3D*cos(this->angle_)+
            this->axis_*(this->axis_*last_point_to_cut3D)*
            (1-cos(this->angle_))+(last_point_to_cut3D*this->axis_)*sin(this->angle_);

    center_cut3D = center_;
    center_cut3D = center_cut3D*cos(this->angle_)+
            this->axis_*(this->axis_*center_cut3D)*
            (1-cos(this->angle_))+(center_cut3D*this->axis_)*sin(this->angle_);
